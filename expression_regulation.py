...
ax1 = fig.add_subplot(121, axis_bgcolor=(0.95,0.92,0.90))
ax2 = fig.add_subplot(122, axis_bgcolor=(0.95,0.92,0.90))

rc.expression_plot(x1, y1, ax1)
rc.expression_plot(x2, y2, ax2, legend=False)


ax1.set_title(r'acetate $\longrightarrow $ glucose')
ax2.set_title(r'glucose limitted chemostats')

ax1.set_ylabel('reactions', size=13)   
